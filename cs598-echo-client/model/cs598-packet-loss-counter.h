...
#ifndef CS598_PACKET_LOSS_COUNTER_H
#define CS598_PACKET_LOSS_COUNTER_H
...
class CS598PacketLossCounter
{
  public:
     ...
     */
    CS598PacketLossCounter(uint8_t bitmapSize);
    ~CS598PacketLossCounter();
    /**
...
#endif /* CS598_PACKET_LOSS_COUNTER_H */
